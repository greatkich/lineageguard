...
- defining the demo scope/profile.
...
| `screenshot` | consistent visual evidence for review/submission |
...
- `sentry` only after the canonical demo works and a Sentry project exists;
...
Trigger before claiming the canonical demo works or before recording.
...
Trigger during final README, examples, deployment, and video preparation.
...
| Release Lead | demo verification, submission readiness | clean run and submission assets |
