...
In less than three minutes, prove that DataHub gives an AI coding agent organizational context it cannot obtain from a repository, and that LineageGuard turns that context into a safe, verified migration.

The demo should feel like a product, not a narrated architecture diagram.
...
### 0:00–0:15 — The local view says safe
...
### 0:15–0:28 — State the context gap
...
### 0:28–1:05 — DataHub discovers hidden consumers
...
### 1:05–1:18 — The winning transition
...
### 1:18–1:52 — The agent performs real work
...
### 1:52–2:15 — Verification, not confidence theater
...
### 2:15–2:35 — Real review artifact
...
4. never debug infrastructure during the recording.
...
- The video proves validation and write-back.
- No claim relies only on voiceover.
- Every shown metric maps to persisted run data.
- The final cut remains under three minutes.
