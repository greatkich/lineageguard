...
3. Ask only questions that materially change implementation or walkthrough success.
...
### F1 — Canonical walkthrough data and DataHub graph
...
02-walkthrough-data-and-datahub-graph.md
...
10-evals-deployment-and-release.md
```
...
- Phase 1 start: walkthrough graph and verified DataHub context;
- Phase 1 checkpoint: parser, context collector, deterministic decision flip;
- August 6: generation and executable validation;
- August 7: GitHub integration and DataHub write-back;
- Phase 2 checkpoint: Mission Control, evals, replay, deployment;
- release readiness: feature freeze, clean-start verification, README, screenshots, walkthrough guide;
- the current product milestone: critical fixes only and early release.
...
6. GitHub authentication mode for live walkthrough;
...
Do not record the walkthrough guide until a clean environment can execute the canonical flow and produce:
