...
- more integration work during a short product release;
...
- Next.js + Node worker;
- TypeScript for all ingestion and walkthrough tooling.
...
## Why this is the best product release decision

The UI is part of the review artifact, not an optional admin screen. TypeScript lets the same team/agent move quickly between the React experience and the orchestration layer without translating every domain contract.
