...
LineageGuard is being built for **Build with DataHub: The Agent Hackathon** in the **Metadata-Aware Code Generation & Development** category.
...
6. **One excellent vertical scenario beats a broad prototype.** The primary demo must run reliably from a clean environment.
...
- **PostgreSQL** for demo business data and LineageGuard run state;
...
| [`docs/WINNING_STRATEGY.md`](docs/WINNING_STRATEGY.md) | How the project maps to the judging criteria |
| [`docs/ARCHITECTURE.md`](docs/ARCHITECTURE.md) | System design, boundaries, data model, runtime, and deployment |
| [`docs/DEMO_STORYBOARD.md`](docs/DEMO_STORYBOARD.md) | The sub-three-minute demo and visual states |
...
- Secondary ambition: **Grand Prize**.

The full implementation, deployment, and submission instructions will be added through the planning workflow.
